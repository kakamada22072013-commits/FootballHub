...
export default function CountriesPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold gradient-text mb-2">Countries</h1>
        <p className="text-slate-400">Browse football by country</p>
      </div>

      <section>
        <h2 className="text-xl font-bold mb-4">Top Football Nations</h2>
